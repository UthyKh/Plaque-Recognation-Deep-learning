...
st.title('DEkra DSI Morroco Automatic Number Plate Recognition (ANPR) in Morocco Licensed Vehicles.')
...
st.write('''This application is a demo result of our work in Dekra DSI. 
